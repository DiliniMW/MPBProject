...
set object 1 rect from graph 0, first 0.2792175236880296 to graph 1, first 0.2935823020304969 behind fc rgb '#FF9999'
set object 2 rect from graph 0, first 0.13427096511986406 to graph 1, first 0.26087150601031645 behind fc rgb 'light-blue'
set object 3 rect from graph 0, first 0.28673711877622793 to graph 1, first 0.39331882976812754 behind fc rgb 'light-blue'
set object 4 rect from graph 0, first 0.4573922611836309 to graph 1, first 0.5726314607264313 behind fc rgb 'light-blue'
set object 5 rect from graph 0, first 0.5733942022797839 to graph 1, first 0.5805628446223388 behind fc rgb 'light-blue'
